...
// .wrangler/tmp/bundle-xu5iVZ/strip-cf-connecting-ip-header.js
...
app.use(
  ...
  cors({
    origin: (origin) => {
      if (!origin || origin.includes("localhost") || origin.includes("127.0.0.1") || origin.endsWith(".vercel.app") || origin.includes("workers.dev")) {
        return origin || "*";
      }
      return origin;
    },
...
async function resolveTruecallerPool(phone, rapidApiKey) {
  if (!rapidApiKey) {
...
__name(resolveTruecallerPool, "resolveTruecallerPool");
...
// .wrangler/tmp/bundle-xu5iVZ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xu5iVZ/middleware-loader.entry.ts
